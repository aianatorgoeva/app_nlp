...
model_path = "models/subset-roberta"
...
st.write("RoBERTa model trained on a subset")
...
if st.button("Determine Toxicity"):
    if comment:
        ...
        inputs = tokenizer(cleaned_comment, return_tensors='tf', truncation=True, padding=True, max_length=128)
